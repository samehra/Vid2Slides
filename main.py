...
if __name__ == "__main__":
  ...
  # action='store_true' is used for verbose, which means if you include --verbose in the command, args.verbose will be True; otherwise, it will be False.
  parser.add_argument('--verbose', action='store_true', help="Print the count of slides and % of frames parsed")
